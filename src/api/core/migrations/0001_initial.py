    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_unavailable_days', models.ManyToManyField(blank=True, related_name='customunavailableday', to='core.customunavailabledaymodel', verbose_name='Dias indisponiveis')),
                ('fixed_unavailable_days', models.ManyToManyField(blank=True, related_name='fixedunavailableday', to='core.fixedunavailabledaymodel', verbose_name='Dias da semana indisponivel')),
                ('fixed_unavailable_hours', models.ManyToManyField(blank=True, related_name='fixedunavailablehour', to='core.fixedunavailablehourmodel', verbose_name='Horarios indisponiveis')),
                ('qualifications', models.ManyToManyField(blank=True, related_name='qualifications', to='core.qualificationmodel', verbose_name='Qualificações')),
                ('specializations', models.ManyToManyField(blank=True, related_name='specialization', to='core.specializationmodel', verbose_name='Especializações')),
                ('work_exp', models.ManyToManyField(blank=True, related_name='workexperience', to='core.workexperiencemodel', verbose_name='Experiencia de trabalho')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_info', models.TextField(blank=True, null=True, verbose_name='Informações Adicionais')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='care_receiver', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caregiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.caregivermodel')),
                ('carereceiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.carereceivermodel')),
            ],
        ),
        migrations.CreateModel(
            name='RatingModel',
            fields=[
                ...
                ('care_request', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.carerequestmodel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('care_receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='special_care_users', to='core.carereceivermodel')),
                ('care_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='special_care_users', to='core.specialcaremodel')),
            ],
        ),
    ]
