...
import { View, Text, TextInput, Picker, Pressable, StyleSheet } from 'react-native';
...
{/*}  useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error("Erro ao cadastrar o Cuidador:", error.message);
    }
  };
    ...
    <View style={styles.container}>
      <View style={styles.formRegister}>
        ...
        <TextInput
          ...
          onBlur={() => handleBlur("confirm_password", formData.confirm_password)}
          secureTextEntry={true}
        />
        {errors.confirm_password && <Text style={styles.error}>{errors.confirm_password}</Text>}
        ...
        />
        {errors.post_code && <Text style={styles.error}>{errors.post_code}</Text>}
      </View>
      <View>
