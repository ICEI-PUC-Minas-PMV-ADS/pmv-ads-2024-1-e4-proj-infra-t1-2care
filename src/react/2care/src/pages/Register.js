                    ...
                    <div id="CarereceiverRegister" style={{ display: 'flex'}}>                  
                        <div className="columnLeft25">
                            ...
                            <div style={{ marginLeft: '2em'}}>
                                ...
                                <p style={{fontWeight: 'bold', textAlign: 'justify', marginRight: '4em'}}> Familiares ou pessoas que buscam por cuidadores para assistência personalizada.</p>
                            </div>
                        </div>
                    ...
                    <div id="CaregiverRegister" style={{ display: 'flex'}}>
                        <div className="columnLeft25">
                            ...
                            <div style={{ marginLeft: '2em'}}>
                                ...
                                <p style={{fontWeight: 'bold', textAlign: 'justify', marginRight: '4em'}}>Para cuidadores e profissionais de home care qualificados que desejam divulgar suas habilidades e experiências para encontrar oportunidades de trabalho na área de cuidadores de pessoas.</p>
                            </div>
                        </div>
                        <div className="columnLeft70">
                            <h1 id="PreenchaOsCampos">Preencha os campos abaixo e crie sua conta!</h1>
