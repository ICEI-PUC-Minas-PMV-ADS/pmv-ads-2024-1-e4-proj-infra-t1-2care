...
import { Box, Button, Modal, Typography, TextField, MenuItem, Slider, FormControl, InputLabel, Select, Grid, Divider } from '@mui/material/';
            ...
            {!location.pathname.includes("/home") ? (
                ...
                <div>
                    <span>
                        ...
                        {isLoggedIn() && (
                            <a className='navBarLink' href="/requests">Propostas</a>
                        )}
                    </span>
                    ...
                    >
                        ...
                        <Box sx={style} component="form">
                            ...
                            <Typography gutterBottom sx={{ mt: 2 }}>Anos de experiência: ( {experience} )</Typography>
                            <Slider
                                value={experience}
                            ...
                            <Typography gutterBottom sx={{ mt: 2 }}>Preço Máximo: (R$ {price}) </Typography>
                            <Slider
                                value={price}
